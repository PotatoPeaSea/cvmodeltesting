"""
BEiT (Bidirectional Encoder representation from Image Transformers) Demo
========================================================================
• Load an image from disk  OR  capture from webcam
• Runs BEiT via ONNX Runtime
...
MODEL_PATH  = os.path.join(SCRIPT_DIR, "beit.onnx")
LABELS_PATH = os.path.join(SCRIPT_DIR, "labels.txt")

INPUT_SIZE   = (224, 224)   # BEiT expects 224×224
...
TEXT_PRI  = "#f0f0f5"
TEXT_SEC  = "#8b8fa8"
BAR_COLORS = ["#3b82f6", "#60a5fa", "#10b981", "#34d399", "#fbbf24"]
...
class BeitApp(tk.Tk):
    ...
    def __init__(self):
        super().__init__()
        self.title("BEiT · Image Transformer Classifier")
    ...
    def _build_ui(self):
        ...
        tk.Label(hdr, text="💎 BEiT Transformer",
                 font=("Segoe UI", 22, "bold"), fg=ACCENT, bg=BG_DARK
                 ).pack(side="left")
        tk.Label(hdr, text="  Vision Transformer  ·  ONNX Runtime",
